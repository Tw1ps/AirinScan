...
# 此处代码来自 OneForAll - https://github.com/shmilylty/OneForAll

# 路径设置
relative_directory = pathlib.Path(__file__).parent.parent.parent  # Airin根目录路径
log_save_dir = relative_directory.joinpath('results')  # 结果保存目录
log_path = log_save_dir.joinpath('airin.log')  # Airin日志保存路径
...
# 如果你想在命令终端静默运行Airin，可以将以下一行中的level设置为QUITE
# 命令终端日志级别默认为INFOR
